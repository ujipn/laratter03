...
// 作成処理のテスト
it('allows authenticated users to create a tweet with an area', function () {
    // ユーザを作成
    $user = User::factory()->create();
    ...
    // Tweetを作成
    $tweetData = ['tweet' => 'This is a test tweet.', 'area' => 'Test Area'];
...
// 更新処理のテスト
it('allows a user to update their tweet with an area', function () {
    // ユーザを作成
    $user = User::factory()->create();
    ...
    // 更新データ
    $updatedData = ['tweet' => 'Updated tweet content.','area' => 'Updated Area'];
